...
public class Science extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDB = new DBHelper(Science.this);
        ...
        customAdapter = new CustomAdapter(Science.this, this, book_id, book_name, book_price,
                book_status, cont, image);
        recyclerView.setAdapter(customAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(Science.this));
    }
    ...
    void storeDataInArrays() {
        Cursor cursor = myDB.scienceData();
