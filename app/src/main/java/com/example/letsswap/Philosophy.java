...
public class Philosophy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDB = new DBHelper(Philosophy.this);
        ...
        customAdapter = new CustomAdapter(Philosophy.this, this, book_id, book_name, book_price,
                book_status, cont, image);
        recyclerView.setAdapter(customAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(Philosophy.this));
    }
    ...
    void storeDataInArrays(){
        Cursor cursor = myDB.philosophyData();
