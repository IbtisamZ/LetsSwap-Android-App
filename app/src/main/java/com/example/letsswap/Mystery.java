...
public class Mystery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDB = new DBHelper(Mystery.this);
        ...
        customAdapter = new CustomAdapter(Mystery.this, this, book_id, book_name, book_price,
                book_status, cont , image);
        recyclerView.setAdapter(customAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(Mystery.this));
    }
    ...
    void storeDataInArrays(){
        Cursor cursor = myDB.mysteryData();
