...
public class Romance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDB = new DBHelper(Romance.this);
        ...
        customAdapter = new CustomAdapter(Romance.this, this, book_id, book_name, book_price,
                book_status, cont, image );
        recyclerView.setAdapter(customAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(Romance.this));
    }
    ...
    void storeDataInArrays(){
        Cursor cursor = myDB.romanceData();
