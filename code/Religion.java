...
public class Religion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDB = new DBHelper(Religion.this);
        ...
        customAdapter = new CustomAdapter(Religion.this, this, book_id, book_name, book_price,
                book_status, cont, image);
        recyclerView.setAdapter(customAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(Religion.this));
    }
    ...
    void storeDataInArrays(){
        Cursor cursor = myDB.religionData();
