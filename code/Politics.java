...
public class Politics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDB = new DBHelper(Politics.this);
        ...
        customAdapter = new CustomAdapter(Politics.this, this, book_id, book_name, book_price,
                book_status, cont, image);
        recyclerView.setAdapter(customAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(Politics.this));
    }
    ...
    void storeDataInArrays(){
        Cursor cursor = myDB.politicsData();
